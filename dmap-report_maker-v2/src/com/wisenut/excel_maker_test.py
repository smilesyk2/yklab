...
from com.wisenut.dao.esclient import EsRejectedExecutionException
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Report("+str(req['seq'])+") creation succeeded.")
    except:
        ex = traceback.format_exc()
        print("Report("+str(req['seq'])+") creation failed. Traceback >> %s " % ex)
